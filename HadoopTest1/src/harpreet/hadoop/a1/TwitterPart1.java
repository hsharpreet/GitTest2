...
public class TwitterPart1 {
    ...
    public static class AllPairsMapper extends Mapper<Object, Text, IntWritable, IntWritable> {
        ...
        public void map(Object key, Text values, Context context) throws IOException, InterruptedException {
            ...
            /*System.out.println("=====");
            System.out.print("st.countTokens()-"+st.countTokens()+" , ");
            ...
            =====
    		st.countTokens()-4 , /1/3/4/5=====
    		=====
    		st.countTokens()-4 , /2/1/3/5=====
    		=====
    		st.countTokens()-5 , /3/1/2/4/5=====
    		=====
    		st.countTokens()-5 , /4/1/2/3/5=====
    		=====
    		st.countTokens()-2 , /5/3=====
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        job.setJarByClass(TwitterPart1.class);
